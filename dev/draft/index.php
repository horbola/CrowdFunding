...
<html>
    ...
    <body>
        <?php
            echo 'this is just to check the avalalbility';
        ?>
        
        <h2>What is Lorem Ipsum?</h2><p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's

...
@section('content')
    <div id="page-wrapper">
        <div class="col-md-12">
                    ...
                    <div class="form-group {{ $errors->has('enable_sslcz')? 'has-error':'' }}">
                        <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                        <div class="col-md-8">
                            <label for="enable_sslcz" class="checkbox-inline">
                                <input type="checkbox" value="1" id="enable_sslcz" name="enable_sslcz" {{ get_option('enable_sslcz') == 1 ? 'checked="checked"': '' }}>
                                Enable SSLCZ
                            </label>
                    ...
                    <div class="form-group {{ $errors->has('enable_walletmix')? 'has-error':'' }}">
                        <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                        <div class="col-md-8">
                            <label for="enable_walletmix" class="checkbox-inline">
                                <input type="checkbox" value="1" id="enable_walletmix" name="enable_walletmix" {{ get_option('enable_walletmix') == 1 ? 'checked="checked"': '' }}>
                                Enable Walletmix
                            </label>

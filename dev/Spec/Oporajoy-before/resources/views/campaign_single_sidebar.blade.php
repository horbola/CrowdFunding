<div class="single-donate-wrap">
    ...
    <div class="campaign-progress-info">
        ...
        <div class="progress">
            ...
            @endphp
                  ...
                  <div class="progress-bar" role="progressbar" aria-valuenow="{{$percent_raised}}"
                  aria-valuemin="0" aria-valuemax="100" style="width: {{$percent_raised <= 100 ? $percent_raised : 100}}%;">
                     {{$percent_raised}}%  
                  </div>
                  
                 <style>.percent{display:none;}</style>
        </div>

        <ul>
            <li>Only <strong>{{($campaign->days_left() >0 )?$campaign->days_left():0}}</strong> Days Left</li>
    ...
    <div class="donate_form">
        ...
        <div class="donate-form-button">
            ...
            @else
            <a href="javascript:void(0)" class="btn btn-primary btn-block btn-lg">@lang('app.donate')</a>
            @endif
        </div>
        {{Form::close()}}

...
Route::post('/walletmixcb', ['uses' => 'CampaignsController@walletmixcb', 'as' => 'walletmixcb']);

Auth::routes();
Route::get('/verifyemail/{token}', 'Auth\RegisterController@verify');
Route::get('/home', 'HomeController@index');
//Comments
Route::post('comments', ['uses' => 'CampaignsController@commentstore', 'as' => 'comments.store']);

//like
Route::post('/like', ['uses' => 'CampaignsController@likestore', 'as' => 'like.store']);
...
Route::post('payment/success', 'CampaignsController@sslPaymentSuccessOrFailed')->name('sslpayment.success');
Route::post('payment/failed', 'CampaignsController@sslPaymentSuccessOrFailed')->name('sslpayment.failed');
Route::post('payment/cancel', 'CampaignsController@sslPaymentSuccessOrFailed')->name('sslpayment.cancel');

Route::post('checkout/submission', ['uses' => 'CampaignsController@wallitmixRedirect', 'as' => 'payment_wallitmix_receive']);
Route::post('checkout/sslcz', ['uses' => 'CampaignsController@sslPayment', 'as' => 'ssl_payment_send']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    Route::get('/controlpanel/', ['as' => 'dashboard', 'uses' => 'DashboardController@dashboard']);
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::group(['prefix'=>'campaigns'], function() {
            ...
            Route::get('edit/{id}', ['as'=>'edit', 'uses' => 'CampaignsController@edit']);
            Route::post('edit/{id}', [ 'uses' => 'CampaignsController@update']);
            ...
            Route::get('comment', ['as'=>'comment', 'uses' => 'CampaignsController@comment']);
            Route::post('comment', ['uses' => 'CampaignsController@commentActive']);
        });
    ...
    Route::group(['prefix'=>'withdraw'], function() {
        ...
        Route::get('/request', ['as'=>'request', 'uses' => 'PaymentController@request']);
        Route::post('/', ['as'=>'withdraw', 'uses' => 'PaymentController@withdrawRequest']);
    });
    ...
    Route::group(['prefix'=>'u'], function(){
        ...
        Route::get('all-users', ['as'=>'all-users', 'uses' => 'UserController@allUsers']);
        Route::get('user/edit/{id}', ['as'=>'user_show', 'uses' => 'UserController@userShow']);
        Route::post('user/edit/{id}', ['as'=>'user_show', 'uses' => 'UserController@userEditPost']);

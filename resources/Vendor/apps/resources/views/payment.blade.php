                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="checkout-wrap">
                        ...
                        <div class="row">
                            ...
                            @if(get_option('enable_walletmix') == 1)
                                <div class="col-md-4">
                                    {{ Form::open(['route' => 'payment_wallitmix_receive']) }}
                            ...
                            @if(get_option('enable_sslcz') == 1)
                                <div class="col-md-4">
                                    {{ Form::open(['route' => 'ssl_payment_send']) }}
                                    <button type="submit" class="btn btn-info"> <i class="fa fa-money"></i> SSLCOMMERZ</button>
                                    {{ Form::close() }}
                                </div>
                            @endif

            ...
            <div class="input">
                <form class="your-comment" action="{{ route('comment.store') }}" method="post">
                    ...
                    <div class="notice text-center">
                        <p><i class="fas fa-exclamation-triangle"></i> This campaign isn't approved yet by authority</p>
                    </div>
                    @elseif(!Auth::check())
                    <div class="notice text-center">
                        <p><i class="fas fa-exclamation-triangle"></i> You must have an account to comment. Alread have an account? <a href="{{ route('login') }}"><span>Log in</span></a></p>
                    </div>
                    @else

<div id="campaign-tabs">
    ...
    <ul class="nav nav-pills shadow flex-column flex-sm-row d-md-inline-flex mb-0 p-1 bg-white rounded position-relative overflow-hidden" id="pills-tab" role="tablist">
        <li class="nav-item m-1">
            <a class="nav-link py-2 px-4 active rounded border border-1" id="description-data" data-bs-toggle="pill" href="#description" role="tab" aria-controls="description" aria-selected="false">
        ...
        <li class="nav-item m-1">
            <a class="nav-link py-2 px-4 rounded border border-1" id="document-info" data-bs-toggle="pill" href="#document" role="tab" aria-controls="additional" aria-selected="false">
                <div class="text-center">
        ...
        <li class="nav-item m-1">
            <a class="nav-link py-2 px-4 rounded border border-1" id="update-number" data-bs-toggle="pill" href="#update" role="tab" aria-controls="review" aria-selected="false">
                <div class="text-center">
        ...
        <li class="nav-item m-1">
            <a class="nav-link py-2 px-4 rounded border border-1" id="donor-comments" data-bs-toggle="pill" href="#donor" role="tab" aria-controls="review" aria-selected="false">
                <div class="text-center">
            ...
            <div class="investigation border border-fuchsia bg-light mt-2 p-2">
                ...
                <div class="d-flex align-items-center mt-3">
                    ...
                    <div class="flex-1 commentor-detail">
                        ...
                        <small class="text-muted">{{App\Library\Helper::formattedTime($campaign->investigation->created_at)}}</small>
                    </div>
                </div>
                <!-- avatar ends ----------------------------------------->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="send d-grid">
                                        <button type="submit" class="btn btn-primary {{ !$campaign->isActive() || !Auth::check() ? 'disabled' : '' }}">Submit</button>
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
                        </form><!--end form-->
            ...
            @if($campaign->updates->count())
                ...
                <div class="d-flex align-items-center mt-3">
                    ...
                    <div class="flex-1 commentor-detail">
                        ...
                        <small class="text-muted">{{App\Library\Helper::formattedTime($anUpdate->created_at)}}</small>
                    </div>
                </div>
                @if($anUpdate->descrip)
                ...
                @if($campaign->donations->count())
                    ...
                    <li class="mt-4 ml-3">
                        <div class="row align-items-center">
                                ...
                                @if($donation->anonymous === 'Open')
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 commentor-detail">
                                            ...
                                            <small class="text-muted">{{App\Library\Helper::formattedTime($donation->created_at)}}</small>
                                        </div>
                                    </div>
                                @else
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 commentor-detail">
                                            <h6 class="mb-0"><a href="javascript:void(0)" class="text-dark media-heading">Anonymous</a></h6>
                                            <!--<small class="text-muted">15th August, 2019 at 01:25 pm</small>-->
                                            <small class="text-muted">{{App\Library\Helper::formattedTime($donation->created_at)}}</small>
                                        </div>
                                    </div>
                            ...
                            <div class="col-2">
                                {{ Helper::formatMoneyFigure($donation->totalPayedAmount()) }}
                            </div>
                        </div>
                    </li>
                    @endforeach
